...
A Widget For Displaying And Selecting members
...
:::note
Make sure to check the [StreamMemberListView](./stream_member_list_view.mdx) documentation to know how to show results in a `ListView`.
:::
