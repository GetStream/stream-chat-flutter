...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      'delete': 'Delete',
      'delete_conversation_are_you_sure': 'Are you sure you want to delete this conversation?',
      ...
      'group_shared_with_user_appear_here': 'Group shared with User will appear here.',
      'last_seen': 'Last seen',
      'leave': 'Leave',
      'leave_conversation': 'Leave conversation',
      'leave_conversation_are_you_sure': 'Are you sure you want to leave this conversation?',
      ...
      'operation_could_not_be_completed': "The operation couldn't be completed.",
      'owner': 'Owner',
      'pin_group': 'Pin group',
      'photos_and_videos': 'Photos & Videos',
      'photos_or_videos_will_appear_here': 'Photos or videos sent in this chat will \nappear here',
      ...
      'remove_member_are_you_sure': 'Are you sure you want to remove this member?',
      'search': 'Search',
    ...
    'it': {
      ...
      'delete': 'Cancella',
      'delete_conversation_are_you_sure': 'Sei sicuro di voler eliminare la conversazione?',
      ...
      'group_shared_with_user_appear_here': "I gruppi in comune con quest'utente compariranno qui",
      'last_seen': 'Ultimo accesso',
      'leave': 'Lascia',
      'leave_conversation': 'Lascia conversazione',
      'leave_conversation_are_you_sure': 'Sei sicuro di voler lasciare questa conversazione?',
      ...
      'operation_could_not_be_completed': "Non é stato possibile completare l'operazione.",
      'owner': 'Proprietario',
      'photos_and_videos': 'Foto & Video',
      'photos_or_videos_will_appear_here': 'Foto or video inviati in questa chat \ncompariranno qui',
      ...
      'remove_member_are_you_sure': 'Sei sicuro di voler rimuovere questo membro?',
      'search': 'Cerca',
      'select_user_to_try_flutter_sdk': "Seleziona un utente per provare l'SDK Flutter",
  ...
  String get leaveConversationAreYouSure {
    return _localizedValues[locale.languageCode]!['leave_conversation_are_you_sure']!;
  }
  ...
  String get messageChannelDescription {
    return _localizedValues[locale.languageCode]!['message_channel_description']!;
  }
  ...
  String get noUserMatchesTheseKeywords {
    return _localizedValues[locale.languageCode]!['no_user_matches_these_keywords']!;
  }
  ...
  String get photosOrVideosWillAppearHere {
    return _localizedValues[locale.languageCode]!['photos_or_videos_will_appear_here']!;
  }
  ...
  String get selectUserToTryFlutterSDK {
    return _localizedValues[locale.languageCode]!['select_user_to_try_flutter_sdk']!;
  }
