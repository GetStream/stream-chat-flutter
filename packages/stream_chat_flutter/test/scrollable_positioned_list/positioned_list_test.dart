...
void main() {
  ...
  testWidgets('List positioned with 20 at halfway', (WidgetTester tester) async {
  ...
  testWidgets('List positioned with 20 half off top of screen', (WidgetTester tester) async {
  ...
  testWidgets('List positioned with 5 at top then scroll up 2', (WidgetTester tester) async {
    await setUpWidgetTest(tester, topItem: 5);
  ...
  testWidgets('List positioned with 5 at top then scroll down 1/2', (WidgetTester tester) async {
    await setUpWidgetTest(tester, topItem: 5);
  ...
  testWidgets('List positioned with 0 at top scroll up 5', (WidgetTester tester) async {
  ...
  testWidgets('List positioned with 5 at top then scroll up 2 programatically', (WidgetTester tester) async {
    final scrollController = ScrollController();
  ...
  testWidgets('List positioned with 5 at top then scroll down 20 programatically', (WidgetTester tester) async {
    final scrollController = ScrollController();
    await setUpWidgetTest(tester, topItem: 5, scrollController: scrollController);
    ...
    expect(itemPositionsNotifier.itemPositions.value.firstWhere((position) => position.index == 25).itemLeadingEdge, 0);
    expect(
      itemPositionsNotifier.itemPositions.value.firstWhere((position) => position.index == 4).itemLeadingEdge,
      -21 / 10,
    );
  ...
  testWidgets('List positioned with 5 at top and initial scroll offset', (WidgetTester tester) async {
  ...
  testWidgets('Does not crash when updated offscreen', (WidgetTester tester) async {
