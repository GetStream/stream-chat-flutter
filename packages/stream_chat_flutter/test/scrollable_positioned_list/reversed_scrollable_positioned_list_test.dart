...
void main() {
  ...
  testWidgets('padding test - centered sliver at bottom', (WidgetTester tester) async {
    final itemScrollController = ItemScrollController();
    await setUpWidgetTest(
      tester,
      itemScrollController: itemScrollController,
    ...
    expect(tester.getBottomLeft(find.text('Item 1')), const Offset(10, screenHeight - (itemHeight + 10)));
    expect(
      tester.getTopRight(find.text('Item 1')),
