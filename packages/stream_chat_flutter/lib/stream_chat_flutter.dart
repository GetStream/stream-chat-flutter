...
export 'package:stream_core_flutter/chat.dart'
    hide
        // Hidden so this package's deprecated typedef stays visible, giving
        // integrators time to migrate before it is removed.
        //
        // Prefer using `Icon(context.streamIcons.*)` instead.
        StreamSvgIconData,
        // Hidden so this package's chat-specialized versions stay the default.
        //
        // They are more tightly integrated with the chat UI and expose
...
export 'src/message_widget/components/stream_message_content.dart';
