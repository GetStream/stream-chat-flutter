...
@Deprecated("Try adding a dependency in the 'pubspec.yaml' instead.")
...
export 'src/message_widget/parse_attachments.dart';
export 'src/message_widget/quoted_message.dart';
