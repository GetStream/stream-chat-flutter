...
Iterable<StreamComponentBuilderExtension<Object>> streamChatComponentBuilders({
  ...
  StreamComponentBuilder<StreamMentionItemProps>? mentionItem,
  ...
  StreamComponentBuilder<StreamVideoPlayerProps>? videoPlayer,
}) {
  final builders = [
    ...
    if (mentionItem != null) StreamComponentBuilderExtension(builder: mentionItem),
    ...
    if (videoPlayer != null) StreamComponentBuilderExtension(builder: videoPlayer),
  ];
