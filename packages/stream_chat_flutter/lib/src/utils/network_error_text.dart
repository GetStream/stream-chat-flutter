...
/// [fallbackDescription] when provided, otherwise to the generic localized
/// copy.
({String title, String description}) resolveNetworkErrorText(
  ...
  return switch (error) {
    StreamChatNetworkError(type: StreamChatNetworkErrorType.connectionError) =>
      (
    ...
    _ => (
        ...
        description:
            fallbackDescription ?? translations.genericErrorDescription,
      ),
  };
}
