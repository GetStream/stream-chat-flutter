...
class StreamThreadListView extends StatelessWidget {
  /// {@macro streamThreadListView}
  const StreamThreadListView({
    super.key,
    required this.controller,
    this.itemBuilder,
    this.separatorBuilder = defaultThreadListViewSeparatorBuilder,
    this.emptyBuilder,
    this.loadingBuilder,
    this.errorBuilder,
    this.onThreadTap,
  ...
  /// The [StreamThreadListController] used to control the threads in the list.
  ...
  final PagedValueScrollViewIndexedWidgetBuilder<Thread> separatorBuilder;
  ...
  Widget build(BuildContext context) {
    return PagedValueListView<String, Thread>(
      ...
      itemBuilder: (context, threads, index) {
        ...
        final tile = StreamThreadListTile(
          ...
          onLongPress: onLongPress == null ? null : () => onLongPress(thread),
        );
      ...
      errorBuilder: (context, error) {
        ...
        final text = resolveNetworkErrorText(context, error,
            fallbackTitle: translations.loadingMessagesError);
...
/// [StreamThreadListTile] items.
class StreamThreadListSeparator extends StatelessWidget {
