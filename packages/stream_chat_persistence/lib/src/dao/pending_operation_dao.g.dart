...
mixin _$PendingOperationDaoMixin on DatabaseAccessor<DriftChatDatabase> {
  $PendingOperationsTable get pendingOperations => attachedDatabase.pendingOperations;
...
class PendingOperationDaoManager {
  ...
  $$PendingOperationsTableTableManager get pendingOperations => $$PendingOperationsTableTableManager(
