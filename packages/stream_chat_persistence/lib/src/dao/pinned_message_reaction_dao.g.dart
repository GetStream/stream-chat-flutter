...
mixin _$PinnedMessageReactionDaoMixin on DatabaseAccessor<DriftChatDatabase> {
  ...
  PinnedMessageReactionDaoManager get managers =>
      PinnedMessageReactionDaoManager(this);
}
