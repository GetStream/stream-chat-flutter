...
class $ChannelQueriesMetadataTable extends ChannelQueriesMetadata
  ...
  sortSpec =
      GeneratedColumn<String>(
        ...
        $ChannelQueriesMetadataTable.$convertersortSpec,
      );
  @override
  List<GeneratedColumn> get $columns => [queryHash, sortSpec];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  ChannelQueryMetadataEntity map(
    ...
    return ChannelQueryMetadataEntity(
      ...
      sortSpec: $ChannelQueriesMetadataTable.$convertersortSpec.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}sort_spec'],
        ),
      ),
    );
  }
  ...
  static TypeConverter<SortOrder<ChannelState>?, String?> $convertersortSpec =
...
class ChannelQueryMetadataEntity extends DataClass
  ...
  final SortOrder<ChannelState>? sortSpec;
  const ChannelQueryMetadataEntity({required this.queryHash, this.sortSpec});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['query_hash'] = Variable<String>(queryHash);
    if (!nullToAbsent || sortSpec != null) {
      map['sort_spec'] = Variable<String>(
        $ChannelQueriesMetadataTable.$convertersortSpec.toSql(sortSpec),
      );
    }
    return map;
  }
  ...
  factory ChannelQueryMetadataEntity.fromJson(
    ...
    return ChannelQueryMetadataEntity(
      queryHash: serializer.fromJson<String>(json['queryHash']),
      sortSpec: serializer.fromJson<SortOrder<ChannelState>?>(json['sortSpec']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'queryHash': serializer.toJson<String>(queryHash),
      'sortSpec': serializer.toJson<SortOrder<ChannelState>?>(sortSpec),
    };
  }

  ChannelQueryMetadataEntity copyWith({
    String? queryHash,
    Value<SortOrder<ChannelState>?> sortSpec = const Value.absent(),
  }) => ChannelQueryMetadataEntity(
    queryHash: queryHash ?? this.queryHash,
    sortSpec: sortSpec.present ? sortSpec.value : this.sortSpec,
  );
  ChannelQueryMetadataEntity copyWithCompanion(
    ...
    return ChannelQueryMetadataEntity(
      queryHash: data.queryHash.present ? data.queryHash.value : this.queryHash,
      sortSpec: data.sortSpec.present ? data.sortSpec.value : this.sortSpec,
    );
  }
  ...
  String toString() {
    return (StringBuffer('ChannelQueryMetadataEntity(')
          ..write('queryHash: $queryHash, ')
          ..write('sortSpec: $sortSpec')
          ..write(')'))
        .toString();
  }

  @override
  int get hashCode => Object.hash(queryHash, sortSpec);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ChannelQueryMetadataEntity &&
          other.queryHash == this.queryHash &&
          other.sortSpec == this.sortSpec);
}

class ChannelQueriesMetadataCompanion
    extends UpdateCompanion<ChannelQueryMetadataEntity> {
  final Value<String> queryHash;
  final Value<SortOrder<ChannelState>?> sortSpec;
  final Value<int> rowid;
  const ChannelQueriesMetadataCompanion({
    this.queryHash = const Value.absent(),
    this.sortSpec = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<ChannelQueryMetadataEntity> custom({
    Expression<String>? queryHash,
    Expression<String>? sortSpec,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
      if (queryHash != null) 'query_hash': queryHash,
      if (sortSpec != null) 'sort_spec': sortSpec,
      if (rowid != null) 'rowid': rowid,
    });
  }
  ...
  ChannelQueriesMetadataCompanion copyWith({
    Value<String>? queryHash,
    Value<SortOrder<ChannelState>?>? sortSpec,
    Value<int>? rowid,
  }) {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sortSpec.present) {
      map['sort_spec'] = Variable<String>(
        $ChannelQueriesMetadataTable.$convertersortSpec.toSql(sortSpec.value),
      );
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
...
class $$ChannelQueriesMetadataTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<
    ...
    String
  >
  get sortSpec => $composableBuilder(
    column: $table.sortSpec,
    builder: (column) => ColumnWithTypeConverterFilters(column),
  );
}
...
class $$ChannelQueriesMetadataTableOrderingComposer
  ...
  ColumnOrderings<String> get sortSpec => $composableBuilder(
    column: $table.sortSpec,
    builder: (column) => ColumnOrderings(column),
  );
}
...
class $$ChannelQueriesMetadataTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<SortOrder<ChannelState>?, String>
  get sortSpec =>
      $composableBuilder(column: $table.sortSpec, builder: (column) => column);
}
