...
class $ChannelQueriesMetadataTable extends ChannelQueriesMetadata
  ...
  late final GeneratedColumnWithTypeConverter<Filter, String> filter =
      GeneratedColumn<String>('filter', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
  ...
  late final GeneratedColumnWithTypeConverter<SortOrder<ChannelState>, String>
      sort = GeneratedColumn<String>('sort', aliasedName, false,
              type: DriftSqlType.string, requiredDuringInsert: true)
  ...
  @override
  ChannelQueryMetadataEntity map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ChannelQueryMetadataEntity(
      ...
      sort: $ChannelQueriesMetadataTable.$convertersort.fromSql(attachedDatabase
          .typeMapping
...
class ChannelQueryMetadataEntity extends DataClass
  ...
  const ChannelQueryMetadataEntity(
      {required this.queryHash, required this.filter, required this.sort});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['query_hash'] = Variable<String>(queryHash);
  ...
  factory ChannelQueryMetadataEntity.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ChannelQueryMetadataEntity(
      queryHash: serializer.fromJson<String>(json['queryHash']),
  ...
  ChannelQueryMetadataEntity copyWith(
          {String? queryHash, Filter? filter, SortOrder<ChannelState>? sort}) =>
...
class $$ChannelQueriesMetadataTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<SortOrder<ChannelState>,
          SortOrder<ChannelState>, String>
...
class $$ChannelQueriesMetadataTableTableManager extends RootTableManager<
    ...
    (
      ChannelQueryMetadataEntity,
      BaseReferences<_$DriftChatDatabase, $ChannelQueriesMetadataTable,
          ChannelQueryMetadataEntity>
    ),
    ChannelQueryMetadataEntity,
    PrefetchHooks Function()> {
  $$ChannelQueriesMetadataTableTableManager(
      _$DriftChatDatabase db, $ChannelQueriesMetadataTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $DriftChatDatabaseManager {
  ...
  $$ChannelQueriesMetadataTableTableManager get channelQueriesMetadata =>
      $$ChannelQueriesMetadataTableTableManager(
          _db, _db.channelQueriesMetadata);
