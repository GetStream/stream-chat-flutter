...
void main() {
  ...
  test('deleteMessageByIds', () async {
    ...
    final reactions = (await database.reactionDao.getReactionsForMessages([firstMessageId]))[firstMessageId]!;
    ...
    final newReactions = (await database.reactionDao.getReactionsForMessages([firstMessageId]))[firstMessageId]!;
  ...
  group('deleteMessageByCids', () {
    ...
    test(
      ...
      () async {
        ...
        final cid1Reactions = (await database.reactionDao.getReactionsForMessages([
          cid1firstMessageId,
        ]))[cid1firstMessageId]!;
        ...
        // Reaction for the first message should be deleted too
        final cid1FetchedReactions = (await database.reactionDao.getReactionsForMessages([
          cid1firstMessageId,
        ]))[cid1firstMessageId]!;
    ...
    test(
      ...
      () async {
        ...
        final cid2Reactions = (await database.reactionDao.getReactionsForMessages([
          cid2FirstMessageId,
        ]))[cid2FirstMessageId]!;
        ...
        expect(cid1FetchedReactions, isEmpty);
        final cid2FetchedReactions = (await database.reactionDao.getReactionsForMessages([
          cid2FirstMessageId,
        ]))[cid2FirstMessageId]!;
