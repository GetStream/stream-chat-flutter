...
final class WebSocketTester {
  ...
  ///
  /// The default 40 ([StreamErrorCode.tokenExpired]) makes the engine refresh
  ...
  /// attempt fails with a [StreamApiException].
  ...
  /// retriable [StreamNetworkException] and the engine schedules background
