...
mixin _$QueryDraftsRequest {
  ...
  /// Create a copy of QueryDraftsRequest
  ...
  @override
  String toString() {
    return 'QueryDraftsRequest(filter: $filter, limit: $limit, next: $next, prev: $prev, sort: $sort)';
  }
}

/// @nodoc
abstract mixin class $QueryDraftsRequestCopyWith<$Res> {
  factory $QueryDraftsRequestCopyWith(
    QueryDraftsRequest value,
    $Res Function(QueryDraftsRequest) _then,
  ) = _$QueryDraftsRequestCopyWithImpl;
  @useResult
  $Res call({
...
class _$QueryDraftsRequestCopyWithImpl<$Res>
  ...
  final $Res Function(QueryDraftsRequest) _then;
