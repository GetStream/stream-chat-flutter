...
MessageUpdate _$MessageUpdateFromJson(Map<String, dynamic> json) => MessageUpdate(
...
Map<String, dynamic> _$MessageUpdateToJson(MessageUpdate instance) => <String, dynamic>{
