...
mixin _$SearchResultMessage {
  ...
  /// Create a copy of SearchResultMessage
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SearchResultMessageCopyWith<SearchResultMessage> get copyWith =>
      _$SearchResultMessageCopyWithImpl<SearchResultMessage>(
        this as SearchResultMessage,
        _$identity,
      );
...
/// @nodoc
class _$SearchResultMessageCopyWithImpl<$Res> implements $SearchResultMessageCopyWith<$Res> {
  _$SearchResultMessageCopyWithImpl(this._self, this._then);

  final SearchResultMessage _self;
  final $Res Function(SearchResultMessage) _then;
