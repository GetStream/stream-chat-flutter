...
/// @nodoc
mixin _$UpdateMessagePartialResponse {
  String get duration;
  MessageResponse? get message;

  /// Create a copy of UpdateMessagePartialResponse
  ...
  @override
  String toString() {
    return 'UpdateMessagePartialResponse(duration: $duration, message: $message)';
  }
}

/// @nodoc
abstract mixin class $UpdateMessagePartialResponseCopyWith<$Res> {
  factory $UpdateMessagePartialResponseCopyWith(
    UpdateMessagePartialResponse value,
    $Res Function(UpdateMessagePartialResponse) _then,
  ) = _$UpdateMessagePartialResponseCopyWithImpl;
  @useResult
...
class _$UpdateMessagePartialResponseCopyWithImpl<$Res>
  ...
  final $Res Function(UpdateMessagePartialResponse) _then;
