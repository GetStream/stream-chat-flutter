...
ActionSequence _$ActionSequenceFromJson(Map<String, dynamic> json) => ActionSequence(
...
Map<String, dynamic> _$ActionSequenceToJson(ActionSequence instance) => <String, dynamic>{
