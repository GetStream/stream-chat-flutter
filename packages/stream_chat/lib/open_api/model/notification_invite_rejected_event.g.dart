...
NotificationInviteRejectedEvent _$NotificationInviteRejectedEventFromJson(
...
Map<String, dynamic> _$NotificationInviteRejectedEventToJson(
  NotificationInviteRejectedEvent instance,
) => <String, dynamic>{
