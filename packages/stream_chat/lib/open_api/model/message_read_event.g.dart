...
MessageReadEvent _$MessageReadEventFromJson(Map<String, dynamic> json) => MessageReadEvent(
...
Map<String, dynamic> _$MessageReadEventToJson(MessageReadEvent instance) => <String, dynamic>{
