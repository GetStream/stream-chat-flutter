...
MessageChangeSet _$MessageChangeSetFromJson(Map<String, dynamic> json) => MessageChangeSet(
...
Map<String, dynamic> _$MessageChangeSetToJson(MessageChangeSet instance) => <String, dynamic>{
