...
ThreadResponse _$ThreadResponseFromJson(Map<String, dynamic> json) => ThreadResponse(
...
Map<String, dynamic> _$ThreadResponseToJson(ThreadResponse instance) => <String, dynamic>{
