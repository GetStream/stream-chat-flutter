...
NotificationChannelDeletedEvent _$NotificationChannelDeletedEventFromJson(
...
Map<String, dynamic> _$NotificationChannelDeletedEventToJson(
  NotificationChannelDeletedEvent instance,
) => <String, dynamic>{
