...
UserDeletedEvent _$UserDeletedEventFromJson(Map<String, dynamic> json) => UserDeletedEvent(
...
Map<String, dynamic> _$UserDeletedEventToJson(UserDeletedEvent instance) => <String, dynamic>{
