...
MessageRequest _$MessageRequestFromJson(Map<String, dynamic> json) => MessageRequest(
  ...
  mentionedUsers: (json['mentioned_users'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ...
  type: json['type'] == null ? null : MessageRequestType.fromJson(json['type'] as String),
);

Map<String, dynamic> _$MessageRequestToJson(MessageRequest instance) => <String, dynamic>{
