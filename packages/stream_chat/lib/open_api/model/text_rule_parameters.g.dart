...
TextRuleParameters _$TextRuleParametersFromJson(Map<String, dynamic> json) => TextRuleParameters(
  ...
  semanticFilterMinThreshold: (json['semantic_filter_min_threshold'] as num?)?.toDouble(),
  semanticFilterNames: (json['semantic_filter_names'] as List<dynamic>?)?.map((e) => e as String).toList(),
  severity: json['severity'] as String?,
  threshold: (json['threshold'] as num?)?.toInt(),
  timeWindow: json['time_window'] as String?,
);

Map<String, dynamic> _$TextRuleParametersToJson(TextRuleParameters instance) => <String, dynamic>{
