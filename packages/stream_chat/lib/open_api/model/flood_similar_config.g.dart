...
FloodSimilarConfig _$FloodSimilarConfigFromJson(Map<String, dynamic> json) => FloodSimilarConfig(
...
Map<String, dynamic> _$FloodSimilarConfigToJson(FloodSimilarConfig instance) => <String, dynamic>{
