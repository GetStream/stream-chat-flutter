...
ChannelKickedEvent _$ChannelKickedEventFromJson(Map<String, dynamic> json) => ChannelKickedEvent(
...
Map<String, dynamic> _$ChannelKickedEventToJson(ChannelKickedEvent instance) => <String, dynamic>{
