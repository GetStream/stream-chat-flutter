...
ChannelMetadata _$ChannelMetadataFromJson(Map<String, dynamic> json) => ChannelMetadata(
...
Map<String, dynamic> _$ChannelMetadataToJson(ChannelMetadata instance) => <String, dynamic>{
  'cid': instance.cid,
