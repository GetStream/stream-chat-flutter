...
mixin _$MemberUserRequest {
  ...
  /// Create a copy of MemberUserRequest
  ...
  @override
  String toString() {
    return 'MemberUserRequest(custom: $custom, id: $id, image: $image, invisible: $invisible, language: $language, name: $name, privacySettings: $privacySettings)';
  }
}

/// @nodoc
abstract mixin class $MemberUserRequestCopyWith<$Res> {
  factory $MemberUserRequestCopyWith(
    MemberUserRequest value,
    $Res Function(MemberUserRequest) _then,
  ) = _$MemberUserRequestCopyWithImpl;
  @useResult
  $Res call({
...
class _$MemberUserRequestCopyWithImpl<$Res>
  ...
  final $Res Function(MemberUserRequest) _then;
