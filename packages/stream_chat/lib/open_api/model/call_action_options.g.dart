...
CallActionOptions _$CallActionOptionsFromJson(Map<String, dynamic> json) => CallActionOptions(
...
Map<String, dynamic> _$CallActionOptionsToJson(CallActionOptions instance) => <String, dynamic>{
