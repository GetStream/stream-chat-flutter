...
part of 'notification_added_to_channel_event.dart';
...
/// @nodoc
mixin _$NotificationAddedToChannelEvent {
  ...
  /// Create a copy of NotificationAddedToChannelEvent
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NotificationAddedToChannelEvent &&
  ...
  @override
  String toString() {
    return 'NotificationAddedToChannelEvent(channel: $channel, channelCustom: $channelCustom, channelId: $channelId, channelMemberCount: $channelMemberCount, channelMessageCount: $channelMessageCount, channelType: $channelType, cid: $cid, createdAt: $createdAt, custom: $custom, member: $member, receivedAt: $receivedAt, team: $team, type: $type)';
  }
}

/// @nodoc
abstract mixin class $NotificationAddedToChannelEventCopyWith<$Res> {
  factory $NotificationAddedToChannelEventCopyWith(
    NotificationAddedToChannelEvent value,
    $Res Function(NotificationAddedToChannelEvent) _then,
  ) = _$NotificationAddedToChannelEventCopyWithImpl;
  @useResult
  $Res call({
...
class _$NotificationAddedToChannelEventCopyWithImpl<$Res>
  ...
  final $Res Function(NotificationAddedToChannelEvent) _then;
