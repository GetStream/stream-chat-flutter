...
SearchWarning _$SearchWarningFromJson(Map<String, dynamic> json) => SearchWarning(
  channelSearchCids: (json['channel_search_cids'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
Map<String, dynamic> _$SearchWarningToJson(SearchWarning instance) => <String, dynamic>{
