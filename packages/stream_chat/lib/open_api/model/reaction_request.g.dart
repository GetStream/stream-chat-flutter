...
ReactionRequest _$ReactionRequestFromJson(Map<String, dynamic> json) => ReactionRequest(
...
Map<String, dynamic> _$ReactionRequestToJson(ReactionRequest instance) => <String, dynamic>{
