...
bool _isVietnameseSpecificRune(int rune) {
  ...
  if (rune == _vietnameseDLower) return true;
  if (rune == _vietnameseDUpper) return true;
  if (rune == _vietnameseOHornLower) return true;
  if (rune == _vietnameseOHornUpper) return true;
  if (rune == _vietnameseUHornLower) return true;
  if (rune == _vietnameseUHornUpper) return true;
