...
Thread _$ThreadFromJson(Map<String, dynamic> json) => Thread(
  ...
  threadParticipants:
      (json['thread_participants'] as List<dynamic>?)
  ...
  latestReplies:
      (json['latest_replies'] as List<dynamic>?)?.map((e) => Message.fromJson(e as Map<String, dynamic>)).toList() ??
      const [],
  read: (json['read'] as List<dynamic>?)?.map((e) => Read.fromJson(e as Map<String, dynamic>)).toList() ?? const [],
