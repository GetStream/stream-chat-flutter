...
mixin _$Role {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, createdAt, custom, name, const DeepCollectionEquality().hash(scopes), updatedAt);
...
abstract mixin class $RoleCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime createdAt, bool custom, String name, List<String> scopes, DateTime updatedAt});
}
