...
MessageOutgoing _$MessageOutgoingFromJson(Map<String, dynamic> json) => MessageOutgoing(
  state: OutgoingState.fromJson(json['state'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$MessageOutgoingToJson(MessageOutgoing instance) => <String, dynamic>{
  'state': instance.state.toJson(),
  'runtimeType': instance.$type,
};

MessageCompleted _$MessageCompletedFromJson(Map<String, dynamic> json) => MessageCompleted(
  state: CompletedState.fromJson(json['state'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$MessageCompletedToJson(MessageCompleted instance) => <String, dynamic>{
  'state': instance.state.toJson(),
  'runtimeType': instance.$type,
};

MessageFailed _$MessageFailedFromJson(Map<String, dynamic> json) => MessageFailed(
  state: FailedState.fromJson(json['state'] as Map<String, dynamic>),
  reason: json['reason'],
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$MessageFailedToJson(MessageFailed instance) => <String, dynamic>{
  'state': instance.state.toJson(),
...
SendingFailed _$SendingFailedFromJson(Map<String, dynamic> json) => SendingFailed(
  skipPush: json['skip_push'] as bool? ?? false,
  skipEnrichUrl: json['skip_enrich_url'] as bool? ?? false,
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$SendingFailedToJson(SendingFailed instance) => <String, dynamic>{
  'skip_push': instance.skipPush,
  'skip_enrich_url': instance.skipEnrichUrl,
  'runtimeType': instance.$type,
};

UpdatingFailed _$UpdatingFailedFromJson(Map<String, dynamic> json) => UpdatingFailed(
  skipPush: json['skip_push'] as bool? ?? false,
  skipEnrichUrl: json['skip_enrich_url'] as bool? ?? false,
  $type: json['runtimeType'] as String?,
);

Map<String, dynamic> _$UpdatingFailedToJson(UpdatingFailed instance) => <String, dynamic>{
  'skip_push': instance.skipPush,
  'skip_enrich_url': instance.skipEnrichUrl,
  'runtimeType': instance.$type,
};
...
DeletingFailed _$DeletingFailedFromJson(Map<String, dynamic> json) => DeletingFailed(
  scope: json['scope'] == null
      ? MessageDeleteScope.softDeleteForAll
      : MessageDeleteScope.fromJson(json['scope'] as Map<String, dynamic>),
  $type: json['runtimeType'] as String?,
...
Map<String, dynamic> _$DeletingFailedToJson(DeletingFailed instance) => <String, dynamic>{
  'scope': instance.scope.toJson(),
  'runtimeType': instance.$type,
};
