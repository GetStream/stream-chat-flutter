...
MessageReminder _$MessageReminderFromJson(Map<String, dynamic> json) => MessageReminder(
...
Map<String, dynamic> _$MessageReminderToJson(MessageReminder instance) => <String, dynamic>{
