...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VotingLimited&&(identical(other.count, count) || other.count == count));
}
...
abstract mixin class $VotingLimitedCopyWith<$Res> implements $PollVotingModeCopyWith<$Res> {
  factory $VotingLimitedCopyWith(VotingLimited value, $Res Function(VotingLimited) _then) = _$VotingLimitedCopyWithImpl;
@useResult
$Res call({
 int count
});
