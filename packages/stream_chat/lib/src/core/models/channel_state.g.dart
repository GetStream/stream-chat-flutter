...
ChannelState _$ChannelStateFromJson(Map<String, dynamic> json) => ChannelState(
  ...
  watchers: (json['watchers'] as List<dynamic>?)?.map((e) => User.fromJson(e as Map<String, dynamic>)).toList(),
  read: (json['read'] as List<dynamic>?)?.map((e) => Read.fromJson(e as Map<String, dynamic>)).toList(),
  membership: json['membership'] == null ? null : Member.fromJson(json['membership'] as Map<String, dynamic>),
  draft: json['draft'] == null ? null : Draft.fromJson(json['draft'] as Map<String, dynamic>),
  pendingMessages: (ChannelState._pendingMessagesReadValue(json, 'pending_messages') as List<dynamic>?)
      ?.map((e) => Message.fromJson(e as Map<String, dynamic>))
      .toList(),
