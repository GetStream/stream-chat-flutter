...
Map<String, dynamic> _$PushPreferenceInputToJson(PushPreferenceInput instance) => <String, dynamic>{
  ...
  if (instance.disabledUntil?.toIso8601String() case final value?) 'disabled_until': value,
...
ChannelPushPreference _$ChannelPushPreferenceFromJson(Map<String, dynamic> json) => ChannelPushPreference(
  chatLevel: json['chat_level'] as ChatLevel?,
  disabledUntil: json['disabled_until'] == null ? null : DateTime.parse(json['disabled_until'] as String),
);

Map<String, dynamic> _$ChannelPushPreferenceToJson(ChannelPushPreference instance) => <String, dynamic>{
  if (instance.chatLevel case final value?) 'chat_level': value,
  if (instance.disabledUntil?.toIso8601String() case final value?) 'disabled_until': value,
};
