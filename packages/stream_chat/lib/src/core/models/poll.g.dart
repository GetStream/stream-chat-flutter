...
Poll _$PollFromJson(Map<String, dynamic> json) => Poll(
  ...
  latestAnswers:
      (json['latest_answers'] as List<dynamic>?)?.map((e) => PollVote.fromJson(e as Map<String, dynamic>)).toList() ??
      const [],
  ...
  ownVotesAndAnswers:
      (json['own_votes'] as List<dynamic>?)?.map((e) => PollVote.fromJson(e as Map<String, dynamic>)).toList() ??
      const [],
...
Map<String, dynamic> _$PollToJson(Poll instance) => <String, dynamic>{
  ...
  'voting_visibility': _$VotingVisibilityEnumMap[instance.votingVisibility]!,
