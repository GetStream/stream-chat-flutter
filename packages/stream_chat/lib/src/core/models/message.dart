...
extension type const MessageType(String rawType) implements String {
  ...
  static const MessageType regular = MessageType('regular');
  ...
  static const MessageType ephemeral = MessageType('ephemeral');

  /// An error message generated as a result of a failed command.
  static const MessageType error = MessageType('error');

  /// The message is a reply to another message.
  static const MessageType reply = MessageType('reply');

  /// A message generated by a system event.
  static const MessageType system = MessageType('system');

  /// A deleted message.
  static const MessageType deleted = MessageType('deleted');
