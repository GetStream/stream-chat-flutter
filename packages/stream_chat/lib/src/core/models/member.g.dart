...
Member _$MemberFromJson(Map<String, dynamic> json) => Member(
  ...
  inviteAcceptedAt: json['invite_accepted_at'] == null ? null : DateTime.parse(json['invite_accepted_at'] as String),
  inviteRejectedAt: json['invite_rejected_at'] == null ? null : DateTime.parse(json['invite_rejected_at'] as String),
  ...
  deletedMessages: (json['deleted_messages'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [],
