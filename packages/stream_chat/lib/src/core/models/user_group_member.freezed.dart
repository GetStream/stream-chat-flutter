...
mixin _$UserGroupMember {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, createdAt, groupId, isAdmin, userId);

  @override
  String toString() {
    return 'UserGroupMember(createdAt: $createdAt, groupId: $groupId, isAdmin: $isAdmin, userId: $userId)';
  }
}
...
abstract mixin class $UserGroupMemberCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime createdAt, String groupId, bool isAdmin, String userId});
}
