...
mixin _$ListDevicesResponse {
  ...
  $ListDevicesResponseCopyWith<ListDevicesResponse> get copyWith =>
      _$ListDevicesResponseCopyWithImpl<ListDevicesResponse>(this as ListDevicesResponse, _$identity);
  ...
  @override
  int get hashCode => Object.hash(runtimeType, duration, const DeepCollectionEquality().hash(devices));

  @override
  String toString() {
    return 'ListDevicesResponse(duration: $duration, devices: $devices)';
  }
}

/// @nodoc
abstract mixin class $ListDevicesResponseCopyWith<$Res> {
  factory $ListDevicesResponseCopyWith(ListDevicesResponse value, $Res Function(ListDevicesResponse) _then) =
      _$ListDevicesResponseCopyWithImpl;
  @useResult
  $Res call({String duration, List<Device> devices});
}
...
class _$ListDevicesResponseCopyWithImpl<$Res> implements $ListDevicesResponseCopyWith<$Res> {
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? duration = null, Object? devices = null}) {
    return _then(
      ListDevicesResponse(
