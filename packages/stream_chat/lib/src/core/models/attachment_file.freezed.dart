...
/// @nodoc
class $PreparingCopyWith<$Res> implements $UploadStateCopyWith<$Res> {
  $PreparingCopyWith(Preparing _, $Res Function(Preparing) __);
}

/// @nodoc
class _$PreparingCopyWithImpl<$Res> implements $PreparingCopyWith<$Res> {
  _$PreparingCopyWithImpl(this._self, this._then);

  final Preparing _self;
  final $Res Function(Preparing) _then;
}
...
/// @nodoc
class $SuccessCopyWith<$Res> implements $UploadStateCopyWith<$Res> {
  $SuccessCopyWith(Success _, $Res Function(Success) __);
}
