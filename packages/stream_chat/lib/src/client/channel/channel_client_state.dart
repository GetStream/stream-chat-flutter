...
class ChannelClientState {
  ...
  ChannelClientState(
    ...
    final handler = ChannelEventHandler(channel: _channel, state: this);
  ...
  @internal
  void removeWatcher(User watcher, {int? watcherCount}) {
