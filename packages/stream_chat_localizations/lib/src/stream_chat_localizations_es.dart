...
No es posible añadir más de $limit archivos adjuntos
  ...
  @override
  String get translatedLabel => 'Traducido';
...
class _AccessibilityTranslationsEs extends AccessibilityTranslations {
  ...
  @override
  String get outgoingReplyToOwnMessageLabel => 'Respondiste a tu propio mensaje';

  @override
  String outgoingReplyToMessageLabel({required String authorName}) => 'Respondiste al mensaje de $authorName';

  @override
  String incomingReplyToOwnMessageLabel({required String replierName}) => '$replierName respondió a tu mensaje';

  @override
  String incomingReplyToMessageLabel({required String replierName, required String authorName}) =>
      '$replierName respondió al mensaje de $authorName';
  ...
  @override
  String get outgoingMessagePreviewLabel => 'Tú';

  @override
  String incomingMessagePreviewLabel({String? senderName}) {
    return senderName ?? 'Mensaje';
  }

  @override
  String outgoingMessageLabel({required String body}) => 'Dijiste, $body';

  @override
  String incomingMessageLabel({required String senderName, required String body}) => '$senderName dijo, $body';

  @override
  String outgoingDeletedMessageLabel({required String body}) => 'Tú, $body';

  @override
  String incomingDeletedMessageLabel({required String senderName, required String body}) => '$senderName, $body';

  @override
  String get pollPreviewLabel => 'Encuesta';

  @override
  String get draftPreviewLabel => 'Borrador';
  ...
  @override
  String get messageDeliveredStatusLabel => 'Entregado';

  @override
  String get messageReadStatusLabel => 'Leído';

  @override
  String get messageFailedStatusLabel => 'No se pudo enviar el mensaje';
  ...
  @override
  String get channelPinnedLabel => 'fijado';
  ...
  String attachmentsAddedAnnouncement({required int count}) {
    return Intl.plural(
      count,
      one: '$count archivo adjunto añadido',
      other: '$count archivos adjuntos añadidos',
      locale: localeName,
    );
  }
  ...
  String attachmentsRemovedAnnouncement({required int count}) {
    return Intl.plural(
      count,
      one: '$count archivo adjunto eliminado',
  ...
  String formatRecentDateTime(DateTime date) {
    if (date.isWithinLastMinute) return 'Ahora mismo';

    final localDate = date.toLocal();
    final jiffyDate = Jiffy.parseFromDateTime(localDate);
    final time = jiffyDate.jm;

    if (localDate.isToday) return 'Hoy a las $time';
    if (localDate.isYesterday) return 'Ayer a las $time';
    if (localDate.isWithinLastWeek) return '${jiffyDate.EEEE} a las $time';
    if (localDate.isInSameYear) {
      return '${jiffyDate.format(pattern: 'd MMM')} a las $time';
    }
    return '${jiffyDate.format(pattern: 'd MMM yyyy')} a las $time';
  }
...
String _languageNameEs(String code) => _languageNamesEs[code] ?? code.toUpperCase();
