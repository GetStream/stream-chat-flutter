...
class StreamChatLocalizationsEs extends GlobalStreamChatLocalizations {
  ...
  @override
  AccessibilityTranslations get accessibility => const _AccessibilityTranslationsEs();
...
class _AccessibilityTranslationsEs implements AccessibilityTranslations {
  const _AccessibilityTranslationsEs();
  ...
  String formatDuration(Duration duration) {
    ...
    final parts = <String>[
      if (hours > 0) Intl.plural(hours, one: '$hours hora', other: '$hours horas', locale: 'es'),
      if (minutes > 0) Intl.plural(minutes, one: '$minutes minuto', other: '$minutes minutos', locale: 'es'),
      if (seconds > 0 || (hours == 0 && minutes == 0))
        Intl.plural(seconds, one: '$seconds segundo', other: '$seconds segundos', locale: 'es'),
    ];
    return parts.join(', ');
  }
}
