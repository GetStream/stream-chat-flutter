...
- Updated `stream_chat` dependency to [`9.30.0`](https://pub.dev/packages/stream_chat/changelog).

## 9.29.0

- Updated `stream_chat` dependency to [`9.29.0`](https://pub.dev/packages/stream_chat/changelog).
