...
class Success<Key,Value> extends PagedValue<Key, Value> {
  const Success({required final  List<Value> items, this.nextPageKey, this.error}): _items = items,super._();
...
/// The current error, if any.
 final  StreamChatException? error;

/// Create a copy of PagedValue
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SuccessCopyWith<Key, Value, Success<Key, Value>> get copyWith => _$SuccessCopyWithImpl<Key, Value, Success<Key, Value>>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success<Key, Value>&&const DeepCollectionEquality().equals(other._items, _items)&&const DeepCollectionEquality().equals(other.nextPageKey, nextPageKey)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(nextPageKey),error);
...
@useResult
$Res call({
 List<Value> items, Key? nextPageKey, StreamChatException? error
});
...
/// Create a copy of PagedValue
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? items = null,Object? nextPageKey = freezed,Object? error = freezed,}) {
  return _then(Success<Key, Value>(
items: null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<Value>,nextPageKey: freezed == nextPageKey ? _self.nextPageKey : nextPageKey // ignore: cast_nullable_to_non_nullable
as Key?,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as StreamChatException?,
  ));
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ErrorCopyWith<Key, Value, Error<Key, Value>> get copyWith => _$ErrorCopyWithImpl<Key, Value, Error<Key, Value>>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Error<Key, Value>&&(identical(other.error, error) || other.error == error));
}
