    ...
    dict(
        ...
        taken=textwrap.dedent("""\
            ...
            - **Persistence stores `mentioned_groups` through `UserGroup.fromData` and `toData`,** generated by the
              ...
              helpers. `includeIfNull: false` keeps the stored JSON identical to the rows v10 wrote, so cached
              messages read back unchanged. `members` needs a `@JsonKey` pair calling `UserGroupMember.fromData`
