...
| ☐ | Delete `stream_chat_error.dart` | Four things first: group 12 removes `StreamChatNetworkError`, phase 07 removes `StreamWebSocketError`, the precondition throws above are reclassified, and the UI's attachment-validation subtypes stop being errors — they are *returned values*, never thrown. | [03](03-errors.md) |
